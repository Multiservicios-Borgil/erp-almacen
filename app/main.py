...
def ver_item(item_id: str, request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse(request=request, name="item.html", context={
            "request": request,
            "item": item,
            "hijos": hijos,
            "historial": historial
...
def buscar(q: str, request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse(request=request, name="panel.html", context={"request": request, "error": "Artículo no encontrado"})
...
def diagnostico_form(item_id: str, request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse(request=request, name="diagnostico.html", context={"request": request, "item": item})
...
def nueva_pieza_form(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse(request=request, name="nueva_pieza.html", context={"request": request, "familias": familias})
...
def print_qr(item_id: str, request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse(request=request, name="print_qr.html", context={"request": request, "item": item})
...
def print_pieza(item_id: str, request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse(request=request, name="print_pieza.html", context={"request": request, "pieza": pieza})
...
def buscar_piezas_avanzado(
    ...
    return templates.TemplateResponse(request=request, name="buscar_piezas.html", context={"request": request, "piezas": piezas, "familias": familias},
    )
